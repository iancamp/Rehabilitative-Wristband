...
public final class FileManager{
	...
	public static void saveToCSV(Baselining b, String id){
		...
		try{
			...
			bw.write("time,magnitude,movement,,,time,magnitude,movement\n");
			...
			while(li.hasNext()){
				...
				if(liLearning.hasNext()){
					...
					bw.write(dp.getTime() + "," + dp.getMagnitude() + "," + dp.getMovement() + ",,," + dpLearning.getTime() + "," + dpLearning.getMagnitude() + "," + dpLearning.getMovement() + "\n"); //write to file
				}
				else
